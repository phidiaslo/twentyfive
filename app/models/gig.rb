class Gig < ActiveRecord::Base
	...
	#CATEGORY_SELECT = ['GRAPHIC DESIGN', 'ONLINE MARKETING', 'WRITING & TRANSLATION', 'VIDEO & ANIMATION', 'MUSIC & AUDIO', 'PROGRAMMING & TECH', 'ADVERTISING', 'BUSINESS', 'LIFESTYLE', 'GIFTS', 'FUN & BIZZARE', 'OTHERS']
    PROCESSING_SELECT = ['1 Business Day', '1-2 Business Days', '1-3 Business Days', '3-5 Business Days', '1-2 Weeks', '2-3 Weeks', '3-4 Weeks']
    DURATION_SELECT = ('1'..'30').to_a
